...
static edgelistitem *emkItem(Dt_t * d, edgelistitem * obj, Dtdisc_t * disc)
{
...
static void efreeItem(Dt_t * d, edgelistitem * obj, Dtdisc_t * disc)
{
    free(obj);
}

static int
ecmpItem(Dt_t * d, Agedge_t ** key1, Agedge_t ** key2, Dtdisc_t * disc)
{
    if (*key1 > *key2)
	return 1;
    else if (*key1 < *key2)
