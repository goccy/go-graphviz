...
static degitem *_mkItem(Dt_t * d, degitem * obj, Dtdisc_t * disc)
{
...
static void _freeItem(Dt_t * d, degitem * obj, Dtdisc_t * disc)
{
    free(obj);
}
...
{
    deglist_t *s = dtopen(&_nodeDisc, Dtoset);
    return s;
}
